...
/**
 * Checks whether a given key exists in the librereader context.
 *
...
/**
 * Returns or initializes the librereader global context object.
 */
function getOrInitContext() {
	globalThis.__librereader ??= { context: new Map() };
	return globalThis.__librereader.context;
}
