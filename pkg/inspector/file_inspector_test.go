...
func TestNewFileInspector(t *testing.T) {
	filePath := "file.txt"
	inspector := inspector.NewFileInspector(filePath)
...
func TestGetMimeType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			inspector := inspector.NewFileInspector(tt.path)
...
func TestIsValidWithFile(t *testing.T) {
	filePath := "file.txt"
	inspector := inspector.NewFileInspector(filePath)
	...
	assert.True(t, inspector.IsValid())
}

func TestIsValidWithNonExistentFile(t *testing.T) {
	filePath := "file.txt"
	inspector := inspector.NewFileInspector(filePath)

	assert.False(t, inspector.IsValid())
}

func TestIsValidWithDirectory(t *testing.T) {
	dirPath := "dir"
	inspector := inspector.NewFileInspector(dirPath)
...
func TestIsValidWithNonExistentDirectory(t *testing.T) {
	dirPath := "dir"
	inspector := inspector.NewFileInspector(dirPath)
